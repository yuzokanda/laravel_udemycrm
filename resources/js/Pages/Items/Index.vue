                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                                    <Link as="button" :href="route('items.create')" class="flex ml-auto text-white bg-indigo-500 border-0 px-2 py-4 focus:outline-none hover:bg-indigo-600 rounded">商品登録</Link>
                                </div>
                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tr v-for="item in items" :key="item.id">
                                            <td class="border-b-2 border-gray-200 px-4 py-3">
                                                <Link class="text-blue-300" :href="route('items.show', { item: item.id })">{{ item.id }}</Link>
                                            </td>
